...
# Date        : Fri 14 Apr 00:07:13 CEST 2023
...
##Locations
g4rootDirName="geant4.10.04.p03"
initial_dir=$PWD
...
rm -rf $instal_log
duildDir=$g4homeDir/$g4rootDirName-build
installDir=$g4homeDir/$g4rootDirName-install
installDataDir=$installDir/share/Geant4-10.4.3/data/
geant4make_sh_dir=$installDir/share/Geant4-10.4.3/geant4make/geant4make.sh
...
packageList=(
    $erlangen_de$g4rootDirName'.tar.gz'
    $geant4_cern_ch'G4NDL.4.5.tar.gz'
    $geant4_cern_ch'G4EMLOW.7.3.tar.gz'
    $geant4_cern_ch'G4PhotonEvaporation.5.2.tar.gz'
    $geant4_cern_ch'G4RadioactiveDecay.5.2.tar.gz'
