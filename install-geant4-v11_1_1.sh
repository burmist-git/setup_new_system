...
rm -rf $instal_log
duildDir=$g4homeDir/geant4-v11.1.1-build
installDir=$g4homeDir/geant4-v11.1.1-install
installDataDir=$installDir/share/Geant4/data/
geant4make_sh_dir=$installDir/share/Geant4/geant4make/geant4make.sh
...
gitlab_cern_ch="https://gitlab.cern.ch/geant4/geant4/-/archive/v11.1.1/"
geant4_cern_ch="https://cern.ch/geant4-data/datasets/"
packageList=(
    $gitlab_cern_ch'geant4-v11.1.1.tar.gz'
    $geant4_cern_ch'G4NDL.4.7.tar.gz'
    $geant4_cern_ch'G4EMLOW.8.2.tar.gz'
    $geant4_cern_ch'G4PhotonEvaporation.5.7.tar.gz'
    $geant4_cern_ch'G4RadioactiveDecay.5.6.tar.gz'
    $geant4_cern_ch'G4PARTICLEXS.4.0.tar.gz'
    $geant4_cern_ch'G4PII.1.3.tar.gz'
    $geant4_cern_ch'G4RealSurface.2.2.tar.gz'
    $geant4_cern_ch'G4SAIDDATA.2.0.tar.gz'
    $geant4_cern_ch'G4ABLA.3.1.tar.gz'
    $geant4_cern_ch'G4INCL.1.0.tar.gz'
    $geant4_cern_ch'G4ENSDFSTATE.2.3.tar.gz'
    $geant4_cern_ch'G4TENDL.1.4.tar.gz'
)
...
function printUsefulInfo {
    ...
    echo "$ cmake -DGeant4_DIR=$installDir/lib/Geant4-11.1.1/ ../exampleXYZ"
